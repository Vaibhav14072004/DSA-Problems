...
public:
    vector<int> leftmostBuildingQueries(vector<int>& heights,vector<vector<int>>& queries) {
        ...
        for (auto it : ref) {
            ...
            auto idx = upper_bound(mp.rbegin(), mp.rend(),make_pair(heights[mini], n));
            // to found the first index which has height greater than maxi
            // index: thats why searching from end.
